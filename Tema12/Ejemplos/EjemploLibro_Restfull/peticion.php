...
if (isset($_POST['filtraPrecio'])) {
    ...
    $data = file_get_contents("http://localhost/PHP/Desarrollo-Web-en-Entorno-Servidor/Tema12/Pruebas%20y%20Ejemplos/EjemploLibro_Restfull/consultaProductos.php" . $parametros);
    ...
    $url = "http://localhost/PHP/Desarrollo-Web-en-Entorno-Servidor/Tema12/Pruebas%20y%20Ejemplos/EjemploLibro_Restfull/consultaProductos.php";
